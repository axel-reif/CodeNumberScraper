    ...
    internal class DvgwScraper : ScraperBase
    {
        ...
        */
        ...
        public async Task<IEnumerable<Marketpartner>> FetchMarketpartners()
        {
            ...
            {
                // Setzen des Accept-Language Headers auf 'de'
                httpClient.DefaultRequestHeaders.AcceptLanguage.Add(new System.Net.Http.Headers.StringWithQualityHeaderValue("de"));
